<template>
  <div class="food-store">
    ...
    <ul :class="['nav-links', { 'active': isMenuOpen }]">
      <!-- Close Icon positioned at the top -->
      <button v-if="isMenuOpen" class="close-menu" @click="closeMenu">
        <i class="fa-solid fa-xmark"></i>
      </button>
      
      <li><a href="#home" @click="closeMenu">Home</a></li>
      <li><a href="#stores" @click="closeMenu">Stores</a></li>
      <li><router-link to="/order" @click="closeMenu">My Orders</router-link></li>
      <li><router-link to="/landing" class="login" @click="logout">Logout</router-link></li>
    </ul>
    </nav>
